  ...
  return (
    <section className="static">
      <div className="max-[639px]:text-center sm:max-[767px]:text-center relative">
        <h1
          className="max-[639px]:w-80 max-[639px]:items-center max-[639px]:mt-10 max-[639px]:text-3xl  
        ...
        >
          Cleanzy te devuelve el tiempo para lo que realmente importa
        </h1>

        <img
          src="/images/imagenHero-removebg.png"
          alt="Hero Image"
          className="w-full"
        />

        <p
          className="max-[639px]:mt-0 max-[639px]:mb-5 
          sm:max-[767px]:text-center sm:max-[767px]:mt-0 sm:max-[767px]:mb-8 sm:px-0
          md:max-[1023px]:absolute md:max-[1023px]:text-2l md:max-[1023px]:max-w-[300px] md:max-[1023px]:top-60 md:max-[1023px]:left-10 md:px-0
          lg:max-[1279px]:absolute lg:max-[1279px]:text-2xl lg:max-[1279px]:max-w-[500px] lg:max-[1279px]:top-72 lg:max-[1279px]:left-10 lg:px-0
          xl:absolute xl:text-3xl xl:max-w-[550px] xl:top-72 xl:left-10 xl:px-0
          mt-12 px-8 leading-[1.3]"
        >
          Limpieza sin esfuerzo con las mejores trabajadoras del hogar.<br></br>
          Cuando quieras, cómo quieras.
        </p>

        <h6
          className="max-[639px]:w-72 max-[639px]:mb-8 
          ...
          mx-auto"
        >
          Ya casi iniciamos, ingresa tu correo y ¡accede a descuentos por
          lanzamiento!
        </h6>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            disabled={loading}
            className="xl:left-[400px] xl:top-[590px] xl:absolute 
        ...
        {successMessage && (
          <p
            className="max-[639px]:mb-0 text-[#D68FD6] 
        ...
        {errorMessage && (
          <p
            className="max-[639px]:mb-0 text-red-500
            sm:max-[767px]:mb-0 sm:max-[767px]:mx-auto sm:max-[767px]:mr-5
            md:max-[1023px]:relative md:max-[1023px]:left-10 md:max-[1023px]:mb-0
            lg:max-[1279px]:relative lg:max-[1279px]:left-10 lg:max-[1279px]:mb-0
            xl:left-10 xl:top-[660px] xl:absolute
